...
class PromoCake(Cake, Promo):
    def __init__(self, cake_name, kind, taste, additives, filling, promo_name,
                 discount, start_date, end_date, minimal_order):
        Cake.__init__(self, cake_name, kind, taste, additives, filling)
        Promo.__init__(self, promo_name, discount, start_date, end_date, minimal_order)
